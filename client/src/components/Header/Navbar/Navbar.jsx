    ...
    <>
      <header className="header_section NavColor" >
        <nav className="navbar navbar-expand-lg custom_nav-container">
          <div className="custom_menu-btn" onClick={() => setShowMenu(true)}><GiHamburgerMenu size={40} /></div>
          <Link to={"/"} className="navbar-brand"><span className="headLogo">Photosec</span></Link>
